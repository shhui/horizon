...
class AuditlogsViewTest(test.BaseAdminViewTests):
    ...
    def test_auditlogs_list(self):
        ...
        api.auditlog.resource_list(IsA(http.HttpRequest)) \
            .AndReturn([])
        # In view method
        api.auditlog.auditlog_list(IsA(http.request.HttpRequest),
                                   marker=None,
                                   paginate=True,
                                   q=IsA(list)) \
            .AndReturn([self.auditlogs.list(), False])
        ...
        res = self.client.get(
            reverse('horizon:project:auditlog:index'))
        self.assertTemplateUsed(res, 'project/auditlog/index.html')
    ...
    def test_auditlogs_list_get_pagination(self):
        ...
        url = reverse('horizon:project:auditlog:index')
