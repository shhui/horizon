...
from auditlogclient.v1 import client as auditlog_client
...
class APITestCase(TestCase):
    ...
    def setUp(self):
        ...
        self._original_auditlogclient = api.auditlog.auditlogclient
        ...
        api.auditlog.auditlogclient = lambda request: \
            self.stub_auditlogclient()
    ...
    def tearDown(self):
        ...
        api.auditlog.auditlogclient = self._original_auditlogclient
    ...
    def stub_auditlogclient(self):
        if not hasattr(self, "auditlogclient"):
            self.mox.StubOutWithMock(auditlog_client, 'Client')
            self.auditlogclient = self.mox.CreateMock(auditlog_client.Client)
        return self.auditlogclient
