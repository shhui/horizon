...
import auditlogclient.exc as auditlog_exceptions
...
def data(TEST):
    ...
    auditlog_exception = auditlog_exceptions.ClientException
    TEST.exceptions.auditlog = create_stubbed_exception(auditlog_exception)
